...
x = data[['Open', 'High', 'Low', 'Close', 'Adj Close',
          'Volume', 'MA', 'BOP', 'MFI', 'MOM',
          'ROC', 'RSI', 'WCP', 'AP', 'MP', 'TP', 'OBV']]
y = data['Class']
...
x.drop(['High', 'Low', 'Close', 'Adj Close','MA','WCP', 'AP', 'MP', 'TP', 'OBV'],axis=1,inplace=True)
...
x.drop(['Open','Volume', 'BOP'],axis=1,inplace=True)
